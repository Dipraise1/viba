...
-- Migrate connected_platforms → platform_connections
...
-- Migrate platform_tokens (direct OAuth) → platform_connections
...
-- Migrate stream_keys from profiles.stream_keys JSON → platform_connections
-- (run manually per user if needed — skipped here since it's a JSONB column)
